...
object FakeDatabase {
    ...
    private fun seedSampleUsers() {
        users.add(User(name = "Alice Student", email = "alice@student.um.edu", role = Role.APPLICANT, id = "user-ahmed-khan"))
        users.add(User(name = "Sarah Lee", email = "sarah@student.um.edu", role = Role.APPLICANT, id = "user-sarah-lee"))
